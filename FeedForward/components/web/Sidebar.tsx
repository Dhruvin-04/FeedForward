...
import { LayoutDashboard, Plus, Package, Home, History, UserCircle, CheckCircle, Users } from 'lucide-react'
...
const menuItems = {
  ...
  ngo: [
    ...
    { href: '/ngo/our-volunteer-pickups', label: 'Our Volunteer Pickups', icon: Users },
